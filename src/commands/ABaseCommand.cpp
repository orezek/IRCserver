...
/*   Updated: 2024/10/28 22:18:54 by orezek           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ABaseCommand::ABaseCommand(Client* client, ClientMessage& clientMessage) : client(client), room(room), clientMessage(clientMessage), serverData(ServerDataManager::getInstance()) {}
