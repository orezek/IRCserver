...
/*   Updated: 2024/09/26 20:57:39 by orezek           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	IRCClient client;
	ASSERT_TRUE(client.connect_to_server(IP, PORT));
...
TEST(IRCProtocolTest, ConnectAndReceiveNotice)
{
	...
	ASSERT_FALSE(response == ":irc.brdevstudio.com NOTICE Auth :*** Looking up your hostname...\r\n");
	client.send_message("PASS pass\r\nNICK testuser\r\nUSER testuser 0 * :Real Name\r\n");
