...
/*   Updated: 2024/09/25 23:38:52 by orezek           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
TEST(IRCProtocolTest, ConnectAndReceiveNotice)
{
	...
	ASSERT_TRUE(response == ":oldrichrezek.com NOTICE Auth :*** Looking up your hostname...\r\n");
	response = client.receive_message();
	ASSERT_TRUE(response == ":oldrichrezek.com NOTICE Auth :*** Could not resolve your hostname: Domain name not found; using your IP address (10.211.55.2) instead.\r\n");
